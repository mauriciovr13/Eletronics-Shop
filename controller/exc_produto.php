				    ...
				    <div class="col-md-12">
                        ...
                        <form action="atualizar_produto.php" method="POST">
                            <div class="col-md-6 register-top-grid">
                                ...
                                <div>
                                    <span>Nome</span>
                                    <input type="text" name="nome" value="<?php echo $view['nome']; ?>" disabled>
                                </div>
                                <div>
                                    <span>Quantidade disponivel</span>
                                    <input type="text" name="qtdDisp" value="<?php echo $view['qtd']; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-md-6 register-top-grid">
								<div>
                                    <span>Preço de compra</span>
                                    <input type="text" name="pCompra" value="<?php echo $view['precoCompra']; ?>" disabled >
                                </div>
                                <div>
                                    <span>Preço de venda</span>
                                    <input type="text" name="pVenda" value="<?php echo $view['precoVenda']; ?>" disabled>
                                </div>
								<div>
                                    <span>Id do Fornecedor</span>
                                    <input type="text" name="idFornecedor" value="<?php echo $view['idFornecedor']; ?>" disabled>
                                </div>
