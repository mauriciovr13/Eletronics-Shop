...
<html>
	<head>
		<title>Produto - Eletronics Shop</title>
						...
						<ul class="menu">
							...
							<li class="item4"><a href="#">Shoes</a>
								<ul class="cute">
									<li class="subitem1"><a href="#">Cute Kittens </a></li>
									<li class="subitem2"><a href="#">Strange Stuff </a></li>
									<li class="subitem3"><a href="produto.php">Automatic Fails </a></li>
								</ul>
							</li>
						</ul>
					</div>
				...
				<div class="col-md-9 product-price1">
					<div class="col-md-5 single-top">	
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="../images/si.jpg"> <img src="../images/si.jpg" /> </li>
								<li data-thumb="../images/si1.jpg"><img src="../images/si1.jpg" /> </li>
								<li data-thumb="../images/si2.jpg"><img src="../images/si2.jpg" /></li>
								<li data-thumb="../images/si.jpg"><img src="../images/si.jpg" /></li>
							</ul>
						</div>
